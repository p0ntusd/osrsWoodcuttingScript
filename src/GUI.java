...
/*This class creates a Graphical User Interface for the user to initialize some variables needed to
 * start the bot. It sends the information to Fisher and then closes the GUI*/
public class GUI extends JFrame implements ActionListener {
    ...
    private final String[] FISH_OPTIONS = {"Small Net", "Bait", "Lure", "Harpoon", "Use-rod"};
    ...
    public GUI() {
        ...
        title = new JLabel("Welcome to Fisher!");
        ...
        fishingSpotLabel = new JLabel("Enter Fishing Spot IDs:");
        ...
        //fish caught objects
        fishgCaughtLabel = new JLabel("Fish Caught ID:");
        ...
        fishingSpeedLabel = new JLabel("Fishing Speed:");
        ...
        slowRadioButton.setLocation(200, 300);
        ...
        fastRadioButton.setLocation(270, 300);
        ...
        mediumRadioButton.setLocation(360, 300);
